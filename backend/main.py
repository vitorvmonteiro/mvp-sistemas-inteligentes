...
try:
    ...
    # Lançamos uma exceção para interromper a inicialização se o modelo estiver ausente.
...
def predict(features: ChurnFeatures):
    ...
    # pois o pipeline do scikit-learn foi treinado com ele.
    ...
    try:
        ...
        # O resultado de .predict() é um array (ex: [0]), então pegamos o primeiro item.
        prediction_value = int(prediction[0])
        
        # Mapeia o resultado numérico para uma string clara para o frontend.
